...
public class SmilyCustomSample {
     ...
     */
    public static YWIMSmiley addImageSmiley(int[] smileyResArray, int horizontalCount, int verticalCount) {
...
//        YWSmilyMgr.addNewSmiley(smiley);
    ...
    /**
     * 设置表情底部引导icon，sdk默认取表情包的第一张图片
     * @param ywimSmiley 要修改底部icon的表情
     * @param resId icon资源id
     */
    public static void setSmileyIndicatorRes(YWIMSmiley ywimSmiley, int resId) {
        YWSmilyMgr.setSmileyIndicatorRes(ywimSmiley, resId);
    }
